...
export default function InsuranceCompanies() {
  ...
  async function handleSave(e) {
    ...
    try {
      ...
      const res = await fetch(`${apiData.PORT}/api/insurancecompanies/insert`, {
        method: "POST",
      ...
      if (!data.success) {
        toast.error(data.error || "Failed to add insurance company");
        return;
      }
      ...
      <div className="users-container">
        ...
        <div className="search-bar-wrapper">
          ...
          <input
            ...
            placeholder="Search insurance companies by name or description..."
            value={searchTerm}
        ...
        <div className="users-card">
          {loading ? (
            <div className="loading-state">
              ...
              <p className="mt-3 text-muted">Loading insurance companies...</p>
            </div>
          ) : filteredCompanies.length === 0 ? (
            <div className="empty-state">
              <div className="empty-state-icon">
                <Shield size={36} color="#9ca3af" />
              </div>
              <h4>{searchTerm ? "No companies found" : "No companies yet"}</h4>
              <p>
                {searchTerm
                  ...
                  <tr key={c.Id}>
                    <td>
                      <button
                        ...
                        onClick={() =>
                          navigate(`/insurancecompanies/detail/${c.Id}/view`)
                        }
                      >
                        {c.Name}
                      </button>
