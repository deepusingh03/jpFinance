...
export default function DealerDetail({ isEdit, resetButton }) {
  ...
  function validate() {
    ...
    if (form.PinCode && form.PinCode.toString().trim()) {
      if (!pinCodeRegex.test(form.PinCode.toString().trim())) {
      ...
      <Form.Group className="mb-3">
        ...
        {editMode && editable ? (
          ...
          <div
            ...
            style={as === "textarea" ? { whiteSpace: "pre-wrap" } : {}}
          >
            {value || "—"}
          </div>
        )}
      ...
      <div className="card p-4 shadow-sm rounded-4">
        ...
        <section className="mb-4">
          ...
          <div className="row">
            ...
            <div className="col-md-6">
              {renderField("Phone", "Phone", { required: true })}
            </div>
        ...
        <section className="mb-4">
          ...
          <div className="row">
            ...
            <div className="col-md-6">
              {renderField("Street", "Street", { as: "textarea", rows: 4 })}
            </div>
          </div>
        </section>
        ...
        <section className="mb-4">
          ...
          <div className="row">
            <div className="col-md-6">
              {renderField("Dealer Owner Name", "OwnerName", {
                editable: true,
              })}
            </div>
          </div>
